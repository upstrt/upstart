      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link to="/solutions" className="text-sm font-medium text-gray-700 hover:text-upxtend-primary transition-colors">Solutions</Link>
            <Link to="/process" className="text-sm font-medium text-gray-700 hover:text-upxtend-primary transition-colors">How It Works</Link>
            <Link to="/calculator" className="text-sm font-medium text-gray-700 hover:text-upxtend-primary transition-colors">Cost Calculator</Link>
            <Link to="/case-studies" className="text-sm font-medium text-gray-700 hover:text-upxtend-primary transition-colors">Case Studies</Link>
            <Link to="/expertise" className="text-sm font-medium text-gray-700 hover:text-upxtend-primary transition-colors">Our Expertise</Link>
            <Button 
              size="sm" 
